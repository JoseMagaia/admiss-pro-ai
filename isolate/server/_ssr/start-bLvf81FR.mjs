...
import { S as SESSION_STORAGE_KEY } from "./client-Cq9-7bp9.mjs";
import { c as createMiddleware, a as attachActiveSpace } from "./space-attacher-BSpWLH7Y.mjs";
...
const startInstance = createStart(() => ({
  functionMiddleware: [attachSupabaseAuth, attachActiveSpace],
