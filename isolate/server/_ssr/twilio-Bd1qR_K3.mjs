import { g as global } from "../_libs/unenv.mjs";
...
var twilio$1 = {};
var hasRequiredTwilio;
function requireTwilio() {
  if (hasRequiredTwilio) return twilio$1;
  hasRequiredTwilio = 1;
  (function() {
    (function(root) {
      var bundle = (/* @__PURE__ */ (function() {
        ...
        var call = require2("./twilio/call.js");
        var device = require2("./twilio/device.js");
        var log = require2("./twilio/log.js");
        var preflight = require2("./twilio/preflight/preflight.js");
        var index = require2("./twilio/errors/index.js");
        Object.defineProperty(exports$1, "Call", {
          enumerable: true,
          get: function() {
            return call.default;
          }
        });
        Object.defineProperty(exports$1, "Device", {
          enumerable: true,
          get: function() {
            return device.default;
          }
        });
        exports$1.Logger = log.Logger;
        Object.defineProperty(exports$1, "PreflightTest", {
          enumerable: true,
          get: function() {
            return preflight.PreflightTest;
          }
        });
        exports$1.TwilioError = index;
      }, { "./twilio/call.js": 9, "./twilio/device.js": 12, "./twilio/errors/index.js": 15, "./twilio/log.js": 18, "./twilio/preflight/preflight.js": 20 }], 2: [function(require2, module, exports$1) {
        var tslib = require2("tslib");
        var deferred = require2("./deferred.js");
        var AsyncQueue = (
          /** @class */
          (function() {
            ...
            AsyncQueue2.prototype.enqueue = function(callback) {
              ...
              this._operations.push({ deferred: deferred$1, callback });
              if (!hasPending) {
                this._processQueue();
              }
            ...
            AsyncQueue2.prototype._processQueue = function() {
              return tslib.__awaiter(this, void 0, void 0, function() {
                var _a, deferred2, callback, result, error, hasResolved, e_1;
                return tslib.__generator(this, function(_b) {
                  switch (_b.label) {
                    case 0:
                      if (!this._operations.length) return [3, 5];
                      _a = this._operations[0], deferred2 = _a.deferred, callback = _a.callback;
                      result = void 0;
                      error = void 0;
                      hasResolved = void 0;
                      _b.label = 1;
        ...
        exports$1.AsyncQueue = AsyncQueue;
      }, { "./deferred.js": 11, "tslib": 41 }], 3: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var tslib = require2("tslib");
        var events = require2("events");
        var device = require2("./device.js");
        var index = require2("./errors/index.js");
        var log = require2("./log.js");
        var outputdevicecollection = require2("./outputdevicecollection.js");
        var mediadeviceinfo = require2("./shims/mediadeviceinfo.js");
        var util = require2("./util.js");
        var kindAliases = {
        ...
        var AudioHelper = (
          /** @class */
          (function(_super) {
            tslib.__extends(AudioHelper2, _super);
            function AudioHelper2(onActiveOutputsChanged, onActiveInputChanged, options) {
              ...
              _this._enabledSounds = (_a = {}, _a[device.default.SoundName.Disconnect] = true, _a[device.default.SoundName.Incoming] = true, _a[device.default.SoundName.Outgoing] = true, _a);
            ...
            Object.defineProperty(AudioHelper2.prototype, "localProcessedStream", {
              /**
               * The processed stream if a local {@link AudioProcessor} was previously added.
               */
              get: function() {
            ...
            Object.defineProperty(AudioHelper2.prototype, "remoteProcessedStream", {
              /**
            ...
            AudioHelper2.prototype._destroyRemoteProcessedStream = function() {
              if (this._remoteProcessor && this._remoteProcessedStream) {
                ...
                this._remoteProcessedStream.getTracks().forEach(function(track) {
                  return track.stop();
                });
            ...
            AudioHelper2.prototype._getAudioProcessorEventObserver = function() {
              return this._audioProcessorEventObserver;
            };
            AudioHelper2.prototype._maybeCreateRemoteProcessedStream = function(stream) {
              var _this = this;
            ...
            AudioHelper2.prototype.addProcessor = function(processor, isRemote) {
              if (isRemote === void 0) {
                isRemote = false;
              }
            ...
            AudioHelper2.prototype.removeProcessor = function(processor, isRemote) {
              if (isRemote === void 0) {
                isRemote = false;
              }
            ...
            AudioHelper2.prototype._destroyLocalProcessedStream = function() {
              if (this._localProcessor && this._localProcessedStream) {
                ...
                this._localProcessedStream.getTracks().forEach(function(track) {
                  return track.stop();
                });
            ...
            AudioHelper2.prototype._getUnknownDeviceIndex = function(mediaDeviceInfo) {
              ...
              var index2 = this._unknownDeviceIndexes[kind][id];
              if (!index2) {
                index2 = Object.keys(this._unknownDeviceIndexes[kind]).length + 1;
                this._unknownDeviceIndexes[kind][id] = index2;
              }
              return index2;
            };
            ...
            AudioHelper2.prototype._maybeCreateLocalProcessedStream = function(stream) {
              var _this = this;
            ...
            AudioHelper2.prototype._restartInputStreams = function() {
                        ...
                        switch (_a2.label) {
                          ...
                          case 1:
                            ...
                            if (typeof deviceId !== "string") {
                              return [2, Promise.reject(new index.InvalidArgumentError("Must specify the device to set"))];
                            }
                            device2 = this.availableInputDevices.get(deviceId);
                            if (!device2) {
                              return [2, Promise.reject(new index.InvalidArgumentError("Device not found: ".concat(deviceId)))];
                            }
                            ...
                            return [2, this._getUserMedia(constraints).then(function(originalStream) {
                              _this2._destroyLocalProcessedStream();
                              return _this2._maybeCreateLocalProcessedStream(originalStream).then(function(newStream) {
            ...
            AudioHelper2.prototype._wrapMediaDeviceInfo = function(mediaDeviceInfo) {
              ...
              if (!options.label) {
                if (options.deviceId === "default") {
                  ...
                  var index2 = this._getUnknownDeviceIndex(mediaDeviceInfo);
                  options.label = "Unknown ".concat(kindAliases[options.kind], " Device ").concat(index2);
                }
              }
        ...
        exports$1.default = AudioHelper$1;
      }, { "./device.js": 12, "./errors/index.js": 15, "./log.js": 18, "./outputdevicecollection.js": 19, "./shims/mediadeviceinfo.js": 33, "./util.js": 37, "events": 39, "tslib": 41 }], 4: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var tslib = require2("tslib");
        var deferred = require2("./deferred.js");
        var eventtarget = require2("./eventtarget.js");
        var AudioPlayer = (
          /** @class */
          (function(_super) {
            tslib.__extends(AudioPlayer2, _super);
            ...
            Object.defineProperty(AudioPlayer2.prototype, "loop", {
              ...
              set: function(shouldLoop) {
                ...
                function pauseAfterPlaythrough() {
                  self2._audioNode.removeEventListener("ended", pauseAfterPlaythrough);
                  self2.pause();
                }
        ...
        exports$1.default = AudioPlayer;
      }, { "./deferred.js": 5, "./eventtarget.js": 6, "tslib": 41 }], 5: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var Deferred = (
          /** @class */
          (function() {
        ...
        exports$1.default = Deferred;
      }, {}], 6: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var tslib = require2("tslib");
        var events = require2("events");
        var EventTarget = (
        ...
        exports$1.default = EventTarget;
      }, { "events": 39, "tslib": 41 }], 7: [function(require2, module, exports$1) {
        var tslib = require2("tslib");
        var events = require2("events");
        var log = require2("./log.js");
        var AudioProcessorEventObserver = (
          /** @class */
          (function(_super) {
            tslib.__extends(AudioProcessorEventObserver2, _super);
            function AudioProcessorEventObserver2() {
              ...
              _this.on("enabled", function(isRemote) {
                return _this._reEmitEvent("enabled", isRemote);
              });
              _this.on("add", function(isRemote) {
                return _this._reEmitEvent("add", isRemote);
              });
              _this.on("remove", function(isRemote) {
                return _this._reEmitEvent("remove", isRemote);
              });
              _this.on("create", function(isRemote) {
                return _this._reEmitEvent("create-processed-stream", isRemote);
              });
              _this.on("destroy", function(isRemote) {
                return _this._reEmitEvent("destroy-processed-stream", isRemote);
              });
              return _this;
            }
            ...
            AudioProcessorEventObserver2.prototype._reEmitEvent = function(name, isRemote) {
        ...
        exports$1.AudioProcessorEventObserver = AudioProcessorEventObserver;
      }, { "./log.js": 18, "events": 39, "tslib": 41 }], 8: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var tslib = require2("tslib");
        var events = require2("events");
        var Backoff = (
          /** @class */
          (function(_super) {
            tslib.__extends(Backoff2, _super);
        ...
        exports$1.default = Backoff;
      }, { "events": 39, "tslib": 41 }], 9: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var tslib = require2("tslib");
        var events = require2("events");
        var backoff = require2("./backoff.js");
        var device = require2("./device.js");
        var index = require2("./errors/index.js");
        var log = require2("./log.js");
        var peerconnection = require2("./rtc/peerconnection.js");
        require2("./rtc/rtcpc.js");
        var icecandidate = require2("./rtc/icecandidate.js");
        var sdp = require2("./rtc/sdp.js");
        var sid = require2("./sid.js");
        var statsMonitor = require2("./statsMonitor.js");
        var util = require2("./util.js");
        var constants = require2("./constants.js");
        var generated = require2("./errors/generated.js");
        var BACKOFF_CONFIG = {
          factor: 1.1,
          jitter: 0.5,
          max: 3e4,
          ...
          function Call(config, options) {
            ...
            _this._onHangup = function(payload) {
              ...
              if (payload.error) {
                ...
                var error = typeof errorConstructor !== "undefined" ? new errorConstructor(payload.error.message) : new generated.GeneralErrors.ConnectionError("Error sent from gateway in HANGUP", payload.error);
            ...
            _this._voiceEventSidGenerator = _this._options.voiceEventSidGenerator || sid.generateVoiceEventSid;
        ...
        })(exports$1.default || (exports$1.default = {}));
      ...
      }, { "./backoff.js": 8, "./constants.js": 10, "./device.js": 12, "./errors/generated.js": 14, "./errors/index.js": 15, "./log.js": 18, "./rtc/icecandidate.js": 25, "./rtc/peerconnection.js": 29, "./rtc/rtcpc.js": 30, "./rtc/sdp.js": 31, "./sid.js": 34, "./statsMonitor.js": 36, "./util.js": 37, "events": 39, "tslib": 41 }], 10: [function(require2, module, exports$1) {
        ...
        exports$1.COWBELL_AUDIO_URL = COWBELL_AUDIO_URL;
        exports$1.ECHO_TEST_DURATION = ECHO_TEST_DURATION;
        exports$1.PACKAGE_NAME = PACKAGE_NAME;
        exports$1.RELEASE_VERSION = RELEASE_VERSION;
        exports$1.SOUNDS_BASE_URL = SOUNDS_BASE_URL;
      }, {}], 11: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var Deferred = (
          /** @class */
          (function() {
        ...
        exports$1.default = Deferred;
      }, {}], 12: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var tslib = require2("tslib");
        var events = require2("events");
        var loglevel = require2("loglevel");
        var audiohelper = require2("./audiohelper.js");
        var audioprocessoreventobserver = require2("./audioprocessoreventobserver.js");
        var call = require2("./call.js");
        var constants = require2("./constants.js");
        var dialtonePlayer = require2("./dialtonePlayer.js");
        var index$1 = require2("./errors/index.js");
        var eventpublisher = require2("./eventpublisher.js");
        var log = require2("./log.js");
        var preflight = require2("./preflight/preflight.js");
        var pstream = require2("./pstream.js");
        var regions = require2("./regions.js");
        var index = require2("./rtc/index.js");
        var getusermedia = require2("./rtc/getusermedia.js");
        var sid = require2("./sid.js");
        var sound = require2("./sound.js");
        var util = require2("./util.js");
        var generated = require2("./errors/generated.js");
        ...
        (function(_super) {
          ...
          function Device(token, options) {
            ...
            _this._createDefaultPayload = function(call2) {
              var payload = {
              ...
              if (call2) {
                var callSid = call2.parameters.CallSid;
                setIfDefined("call_sid", /^TJ/.test(callSid) ? void 0 : callSid);
                setIfDefined("temp_call_sid", call2.outboundConnectionId);
                setIfDefined("audio_codec", call2.codec);
                payload.direction = call2.direction;
              }
            ...
            _this._onSignalingConnected = function(payload) {
              ...
              (_a2 = _this._publisher) === null || _a2 === void 0 ? void 0 : _a2.setHost(regions.createEventGatewayURI(payload.home));
              if (payload.token) {
            ...
            _this._onSignalingError = function(payload) {
              ...
              var call2 = typeof callsid === "string" && _this._findCall(callsid) || void 0;
              ...
              _this.emit(Device.EventName.Error, twilioError, call2);
            };
            _this._onSignalingInvite = function(payload) {
              return tslib.__awaiter(_this, void 0, void 0, function() {
                var wasBusy, callParameters, customParameters, call2, play;
                var _this2 = this;
                var _a2;
                return tslib.__generator(this, function(_b) {
                  switch (_b.label) {
                    ...
                    case 4:
                      this._calls.push(call2);
                      call2.once("accept", function() {
                        _this2._soundcache.get(Device.SoundName.Incoming).stop();
                        _this2._publishNetworkChange();
                      });
                      play = ((_a2 = this._audio) === null || _a2 === void 0 ? void 0 : _a2.incoming()) && !wasBusy ? function() {
                        return _this2._soundcache.get(Device.SoundName.Incoming).play();
                      } : function() {
                        return Promise.resolve();
                      };
                      this._showIncomingCall(call2, play);
                      return [
                        2
                        /*return*/
                      ];
            ...
            _this._updateInputStream = function(inputStream) {
              var call2 = _this._activeCall;
              if (call2 && !inputStream) {
              ...
              return call2 ? call2._setInputTracksFromStream(inputStream) : Promise.resolve();
            };
            ...
            if (util.isLegacyEdge()) {
              throw new index$1.NotSupportedError("Microsoft Edge Legacy (https://support.microsoft.com/en-us/help/4533505/what-is-microsoft-edge-legacy) is deprecated and will not be able to connect to Twilio to make or receive calls after September 1st, 2020. Please see this documentation for a list of supported browsers https://www.twilio.com/docs/voice/client/javascript#supported-browsers");
            }
            ...
            var root2 = globalThis;
            var browser = root2.msBrowser || root2.browser || root2.chrome;
            _this._isBrowserExtension = !!browser && !!browser.runtime && !!browser.runtime.id || !!root2.safari && !!root2.safari.extension;
            ...
            return tslib.__awaiter(this, arguments, void 0, function(options) {
              ...
              return tslib.__generator(this, function(_b) {
                switch (_b.label) {
                  ...
                  case 4:
                    this._calls.splice(0).forEach(function(call2) {
                      return call2.ignore();
                    });
            ...
            return tslib.__awaiter(this, void 0, void 0, function() {
              return tslib.__generator(this, function(_a) {
                switch (_a.label) {
                  ...
                  case 2:
                    _a.sent();
                    return [4, util.promisifyEvents(this, Device.State.Registered, Device.State.Unregistered)];
                  case 3:
                    _a.sent();
                    return [
                      2
                ...
                switch (_a.label) {
                  case 0:
                    ...
                    if (this.state !== Device.State.Registered) {
                      throw new index$1.InvalidStateError('Attempt to unregister when device is in state "'.concat(this.state, '". ') + 'Must be "'.concat(Device.State.Registered, '".'));
                    }
                    this._shouldReRegister = false;
          ...
          Device.prototype.updateOptions = function(options) {
            ...
            for (var _a = 0, _b = Object.keys(Device._defaultSounds); _a < _b.length; _a++) {
              ...
              var defaultUrl = "".concat(constants.SOUNDS_BASE_URL, "/").concat(soundDef.filename, ".").concat(Device.extension) + "?cache=".concat(constants.RELEASE_VERSION);
          ...
          Device.prototype._findCall = function(callSid) {
            return this._calls.find(function(call2) {
              return call2.parameters.CallSid === callSid || call2.outboundConnectionId === callSid;
            }) || null;
          };
                ...
                switch (_c.label) {
                  ...
                  case 3:
                    ...
                    call$1.once("accept", function() {
                      ...
                      if (call$1.direction === call.default.CallDirection.Outgoing && ((_a2 = _this._audio) === null || _a2 === void 0 ? void 0 : _a2.outgoing()) && !isReconnect) {
                      ...
                      if ((_b2 = _this._audio) === null || _b2 === void 0 ? void 0 : _b2.localProcessedStream) {
                        (_c2 = _this._audioProcessorEventObserver) === null || _c2 === void 0 ? void 0 : _c2.emit("enabled", false);
                      }
          ...
          Device.prototype._removeCall = function(call2) {
            if (this._activeCall === call2) {
              this._activeCall = null;
              this._makeCallPromise = null;
            }
            for (var i = this._calls.length - 1; i >= 0; i--) {
              if (call2 === this._calls[i]) {
          ...
          Device.prototype._setupLoglevel = function(logLevel) {
            var level = typeof logLevel === "number" || typeof logLevel === "string" ? logLevel : loglevel__namespace.levels.ERROR;
          ...
          Device.prototype._setupStream = function() {
            ...
            return this._streamConnectedPromise = util.promisifyEvents(this._stream, "connected", "close").then(function() {
              return _this._stream;
            });
          };
          Device.prototype._showIncomingCall = function(call2, play) {
            var _this = this;
            var timeout;
            return Promise.race([
              play(),
              ...
              _this._log.debug("#incoming", JSON.stringify({
                customParameters: call2.customParameters,
                parameters: call2.parameters
              }));
              _this.emit(Device.EventName.Incoming, call2);
            });
          };
          ...
          Device.prototype._updateSpeakerSinkIds = function(sinkIds) {
            ...
            var call2 = this._activeCall;
            return call2 ? call2._setSinkIds(sinkIds) : Promise.resolve();
          };
        ...
        exports$1.default = DialtonePlayer;
      }, { "./errors/index.js": 15 }], 14: [function(require2, module, exports$1) {
        var tslib = require2("tslib");
        var twilioError = require2("./twilioError.js");
        exports$1.AuthorizationErrors = void 0;
        (function(AuthorizationErrors) {
          var AccessTokenInvalid = (
            /** @class */
            (function(_super) {
              tslib.__extends(AccessTokenInvalid2, _super);
          ...
          var AccessTokenExpired = (
            /** @class */
            (function(_super) {
              tslib.__extends(AccessTokenExpired2, _super);
          ...
          var AuthenticationFailed = (
            /** @class */
            (function(_super) {
              tslib.__extends(AuthenticationFailed2, _super);
        ...
        })(exports$1.AuthorizationErrors || (exports$1.AuthorizationErrors = {}));
        exports$1.SignatureValidationErrors = void 0;
        (function(SignatureValidationErrors) {
          var AccessTokenSignatureValidationFailed = (
            /** @class */
            (function(_super) {
              tslib.__extends(AccessTokenSignatureValidationFailed2, _super);
        ...
        })(exports$1.SignatureValidationErrors || (exports$1.SignatureValidationErrors = {}));
        exports$1.ClientErrors = void 0;
        (function(ClientErrors) {
          var BadRequest = (
            /** @class */
            (function(_super) {
              tslib.__extends(BadRequest2, _super);
          ...
          var NotFound = (
            /** @class */
            (function(_super) {
              tslib.__extends(NotFound2, _super);
          ...
          var TemporarilyUnavailable = (
            /** @class */
            (function(_super) {
              tslib.__extends(TemporarilyUnavailable2, _super);
          ...
          var BusyHere = (
            /** @class */
            (function(_super) {
              tslib.__extends(BusyHere2, _super);
        ...
        })(exports$1.ClientErrors || (exports$1.ClientErrors = {}));
        exports$1.SIPServerErrors = void 0;
        (function(SIPServerErrors) {
          var Decline = (
            /** @class */
            (function(_super) {
              tslib.__extends(Decline2, _super);
        ...
        })(exports$1.SIPServerErrors || (exports$1.SIPServerErrors = {}));
        exports$1.GeneralErrors = void 0;
        (function(GeneralErrors) {
          var UnknownError = (
            /** @class */
            (function(_super) {
              tslib.__extends(UnknownError2, _super);
          ...
          var ApplicationNotFoundError = (
            /** @class */
            (function(_super) {
              tslib.__extends(ApplicationNotFoundError2, _super);
          ...
          var ConnectionDeclinedError = (
            /** @class */
            (function(_super) {
              tslib.__extends(ConnectionDeclinedError2, _super);
          ...
          var ConnectionTimeoutError = (
            /** @class */
            (function(_super) {
              tslib.__extends(ConnectionTimeoutError2, _super);
          ...
          var ConnectionError = (
            /** @class */
            (function(_super) {
              tslib.__extends(ConnectionError2, _super);
          ...
          var CallCancelledError = (
            /** @class */
            (function(_super) {
              tslib.__extends(CallCancelledError2, _super);
          ...
          var TransportError = (
            /** @class */
            (function(_super) {
              tslib.__extends(TransportError2, _super);
        ...
        })(exports$1.GeneralErrors || (exports$1.GeneralErrors = {}));
        exports$1.MalformedRequestErrors = void 0;
        (function(MalformedRequestErrors) {
          var MalformedRequestError = (
            /** @class */
            (function(_super) {
              tslib.__extends(MalformedRequestError2, _super);
          ...
          var MissingParameterArrayError = (
            /** @class */
            (function(_super) {
              tslib.__extends(MissingParameterArrayError2, _super);
          ...
          var AuthorizationTokenMissingError = (
            /** @class */
            (function(_super) {
              tslib.__extends(AuthorizationTokenMissingError2, _super);
          ...
          var MaxParameterLengthExceededError = (
            /** @class */
            (function(_super) {
              tslib.__extends(MaxParameterLengthExceededError2, _super);
          ...
          var InvalidBridgeTokenError = (
            /** @class */
            (function(_super) {
              tslib.__extends(InvalidBridgeTokenError2, _super);
          ...
          var InvalidClientNameError = (
            /** @class */
            (function(_super) {
              tslib.__extends(InvalidClientNameError2, _super);
          ...
          var ReconnectParameterInvalidError = (
            /** @class */
            (function(_super) {
              tslib.__extends(ReconnectParameterInvalidError2, _super);
        ...
        })(exports$1.MalformedRequestErrors || (exports$1.MalformedRequestErrors = {}));
        (function(AuthorizationErrors) {
          var AuthorizationError = (
            /** @class */
            (function(_super) {
              tslib.__extends(AuthorizationError2, _super);
          ...
          var NoValidAccountError = (
            /** @class */
            (function(_super) {
              tslib.__extends(NoValidAccountError2, _super);
          ...
          var InvalidJWTTokenError = (
            /** @class */
            (function(_super) {
              tslib.__extends(InvalidJWTTokenError2, _super);
          ...
          var JWTTokenExpiredError = (
            /** @class */
            (function(_super) {
              tslib.__extends(JWTTokenExpiredError2, _super);
          ...
          var RateExceededError = (
            /** @class */
            (function(_super) {
              tslib.__extends(RateExceededError2, _super);
          ...
          var JWTTokenExpirationTooLongError = (
            /** @class */
            (function(_super) {
              tslib.__extends(JWTTokenExpirationTooLongError2, _super);
          ...
          var ReconnectAttemptError = (
            /** @class */
            (function(_super) {
              tslib.__extends(ReconnectAttemptError2, _super);
          ...
          var CallMessageEventTypeInvalidError = (
            /** @class */
            (function(_super) {
              tslib.__extends(CallMessageEventTypeInvalidError2, _super);
          ...
          var PayloadSizeExceededError = (
            /** @class */
            (function(_super) {
              tslib.__extends(PayloadSizeExceededError2, _super);
        ...
        exports$1.UserMediaErrors = void 0;
        (function(UserMediaErrors) {
          var PermissionDeniedError = (
            /** @class */
            (function(_super) {
              tslib.__extends(PermissionDeniedError2, _super);
          ...
          var AcquisitionFailedError = (
            /** @class */
            (function(_super) {
              tslib.__extends(AcquisitionFailedError2, _super);
        ...
        })(exports$1.UserMediaErrors || (exports$1.UserMediaErrors = {}));
        exports$1.SignalingErrors = void 0;
        (function(SignalingErrors) {
          ...
          var ConnectionDisconnected = (
            /** @class */
            (function(_super) {
              tslib.__extends(ConnectionDisconnected2, _super);
        ...
        })(exports$1.SignalingErrors || (exports$1.SignalingErrors = {}));
        exports$1.MediaErrors = void 0;
        (function(MediaErrors) {
          var ClientLocalDescFailed = (
            /** @class */
            (function(_super) {
              tslib.__extends(ClientLocalDescFailed2, _super);
          ...
          var ClientRemoteDescFailed = (
            /** @class */
            (function(_super) {
              tslib.__extends(ClientRemoteDescFailed2, _super);
        ...
        })(exports$1.MediaErrors || (exports$1.MediaErrors = {}));
        var errorsByCode = /* @__PURE__ */ new Map([
          [20101, exports$1.AuthorizationErrors.AccessTokenInvalid],
          [20104, exports$1.AuthorizationErrors.AccessTokenExpired],
          [20151, exports$1.AuthorizationErrors.AuthenticationFailed],
          [31202, exports$1.SignatureValidationErrors.AccessTokenSignatureValidationFailed],
          [31400, exports$1.ClientErrors.BadRequest],
          [31404, exports$1.ClientErrors.NotFound],
          [31480, exports$1.ClientErrors.TemporarilyUnavailable],
          [31486, exports$1.ClientErrors.BusyHere],
          [31603, exports$1.SIPServerErrors.Decline],
          [31e3, exports$1.GeneralErrors.UnknownError],
          [31001, exports$1.GeneralErrors.ApplicationNotFoundError],
          [31002, exports$1.GeneralErrors.ConnectionDeclinedError],
          [31003, exports$1.GeneralErrors.ConnectionTimeoutError],
          [31005, exports$1.GeneralErrors.ConnectionError],
          [31008, exports$1.GeneralErrors.CallCancelledError],
          [31009, exports$1.GeneralErrors.TransportError],
          [31100, exports$1.MalformedRequestErrors.MalformedRequestError],
          [31101, exports$1.MalformedRequestErrors.MissingParameterArrayError],
          [31102, exports$1.MalformedRequestErrors.AuthorizationTokenMissingError],
          [31103, exports$1.MalformedRequestErrors.MaxParameterLengthExceededError],
          [31104, exports$1.MalformedRequestErrors.InvalidBridgeTokenError],
          [31105, exports$1.MalformedRequestErrors.InvalidClientNameError],
          [31107, exports$1.MalformedRequestErrors.ReconnectParameterInvalidError],
          [31201, exports$1.AuthorizationErrors.AuthorizationError],
          [31203, exports$1.AuthorizationErrors.NoValidAccountError],
          [31204, exports$1.AuthorizationErrors.InvalidJWTTokenError],
          [31205, exports$1.AuthorizationErrors.JWTTokenExpiredError],
          [31206, exports$1.AuthorizationErrors.RateExceededError],
          [31207, exports$1.AuthorizationErrors.JWTTokenExpirationTooLongError],
          [31209, exports$1.AuthorizationErrors.ReconnectAttemptError],
          [31210, exports$1.AuthorizationErrors.CallMessageEventTypeInvalidError],
          [31212, exports$1.AuthorizationErrors.PayloadSizeExceededError],
          [31401, exports$1.UserMediaErrors.PermissionDeniedError],
          [31402, exports$1.UserMediaErrors.AcquisitionFailedError],
          [53e3, exports$1.SignalingErrors.ConnectionError],
          [53001, exports$1.SignalingErrors.ConnectionDisconnected],
          [53400, exports$1.MediaErrors.ClientLocalDescFailed],
          [53402, exports$1.MediaErrors.ClientRemoteDescFailed],
          [53405, exports$1.MediaErrors.ConnectionError]
        ]);
        Object.freeze(errorsByCode);
        exports$1.TwilioError = twilioError.default;
        exports$1.errorsByCode = errorsByCode;
      }, { "./twilioError.js": 16, "tslib": 41 }], 15: [function(require2, module, exports$1) {
        var tslib = require2("tslib");
        var generated = require2("./generated.js");
        var twilioError = require2("./twilioError.js");
        ...
        var InvalidArgumentError = (
          /** @class */
          (function(_super) {
            tslib.__extends(InvalidArgumentError2, _super);
        ...
        var InvalidStateError = (
          /** @class */
          (function(_super) {
            tslib.__extends(InvalidStateError2, _super);
        ...
        var NotSupportedError = (
          /** @class */
          (function(_super) {
            tslib.__extends(NotSupportedError2, _super);
        ...
        Object.defineProperty(exports$1, "AuthorizationErrors", {
          enumerable: true,
          get: function() {
            return generated.AuthorizationErrors;
          }
        });
        Object.defineProperty(exports$1, "ClientErrors", {
          enumerable: true,
          get: function() {
            return generated.ClientErrors;
          }
        });
        Object.defineProperty(exports$1, "GeneralErrors", {
          enumerable: true,
          get: function() {
            return generated.GeneralErrors;
          }
        });
        Object.defineProperty(exports$1, "MalformedRequestErrors", {
          enumerable: true,
          get: function() {
            return generated.MalformedRequestErrors;
          }
        });
        Object.defineProperty(exports$1, "MediaErrors", {
          enumerable: true,
          get: function() {
            return generated.MediaErrors;
          }
        });
        Object.defineProperty(exports$1, "SIPServerErrors", {
          enumerable: true,
          get: function() {
            return generated.SIPServerErrors;
          }
        });
        Object.defineProperty(exports$1, "SignalingErrors", {
          enumerable: true,
          get: function() {
            return generated.SignalingErrors;
          }
        });
        Object.defineProperty(exports$1, "SignatureValidationErrors", {
          enumerable: true,
          get: function() {
            return generated.SignatureValidationErrors;
          }
        });
        Object.defineProperty(exports$1, "UserMediaErrors", {
          enumerable: true,
          get: function() {
            return generated.UserMediaErrors;
          }
        });
        exports$1.TwilioError = twilioError.default;
        exports$1.InvalidArgumentError = InvalidArgumentError;
        exports$1.InvalidStateError = InvalidStateError;
        exports$1.NotSupportedError = NotSupportedError;
        exports$1.getErrorByCode = getErrorByCode;
        exports$1.getPreciseSignalingErrorByCode = getPreciseSignalingErrorByCode;
        exports$1.hasErrorByCode = hasErrorByCode;
      }, { "./generated.js": 14, "./twilioError.js": 16, "tslib": 41 }], 16: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var tslib = require2("tslib");
        var TwilioError = (
          /** @class */
          (function(_super) {
            tslib.__extends(TwilioError2, _super);
        ...
        exports$1.default = TwilioError;
      }, { "tslib": 41 }], 17: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var tslib = require2("tslib");
        var events = require2("events");
        var log = require2("./log.js");
        var request = require2("./request.js");
        var EventPublisher = (
          /** @class */
          (function(_super) {
            tslib.__extends(EventPublisher2, _super);
        ...
        exports$1.default = EventPublisher;
      }, { "./log.js": 18, "./request.js": 23, "events": 39, "tslib": 41 }], 18: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var tslib = require2("tslib");
        var loglevel = require2("loglevel");
        var constants = require2("./constants.js");
          ...
          (function() {
            ...
            Log2.getLogLevelInstance = function(options) {
              if (!Log2.loglevelInstance) {
                try {
                  Log2.loglevelInstance = (options && options.LogLevelModule ? options.LogLevelModule : loglevel__namespace).getLogger(constants.PACKAGE_NAME);
                } catch (_a) {
            ...
            Log2.levels = loglevel__namespace.levels;
            return Log2;
          })()
        );
      ...
      }, { "./constants.js": 10, "loglevel": 40, "tslib": 41 }], 19: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var constants = require2("./constants.js");
        var index = require2("./errors/index.js");
        var log = require2("./log.js");
        ...
        exports$1.default = OutputDeviceCollection;
      }, { "./constants.js": 10, "./errors/index.js": 15, "./log.js": 18 }], 20: [function(require2, module, exports$1) {
        var tslib = require2("tslib");
        var events = require2("events");
        var call = require2("../call.js");
        var device = require2("../device.js");
        var index = require2("../errors/index.js");
        var log = require2("../log.js");
        var stats = require2("../rtc/stats.js");
        var constants = require2("../constants.js");
        var generated = require2("../errors/generated.js");
        exports$1.PreflightTest = /** @class */
        (function(_super) {
          ...
          function PreflightTest(token, options) {
            ...
            _this._initDevice(token, tslib.__assign(tslib.__assign({}, _this._options), { fileInputStream: _this._options.fakeMicInput ? _this._getStreamFromFile() : void 0 }));
            var userOptions = [
              "codecPreferences",
              "edge",
              "fakeMicInput",
          ...
          PreflightTest.prototype.stop = function() {
            ...
            if (this._device) {
              this._device.once(device.default.EventName.Unregistered, function() {
          ...
          PreflightTest.prototype._getReport = function() {
            ...
            if (stats2) {
              report.callQuality = this._getCallQuality(stats2.mos.average);
            }
            return report;
          };
                ...
                switch (_b.label) {
                  ...
                  case 1:
                    ...
                    this._call.once("disconnect", function() {
                      _this._device.once(device.default.EventName.Unregistered, function() {
          ...
          PreflightTest.prototype._setupCallHandlers = function(call2) {
            var _this = this;
            if (this._options.fakeMicInput) {
              call2.once("volume", function() {
                call2["_mediaHandler"].outputs.forEach(function(output) {
                  return output.audio.muted = true;
                });
              });
            }
            call2.on("warning", function(name, data) {
              _this._emitWarning(name, "Received an RTCWarning. See .rtcWarning for the RTCWarning", data);
            });
            call2.once("accept", function() {
              _this._callSid = call2["_mediaHandler"].callSid;
            ...
            call2.on("sample", function(sample) {
              return tslib.__awaiter(_this, void 0, void 0, function() {
                var _a;
                return tslib.__generator(this, function(_b) {
                  switch (_b.label) {
                    case 0:
                      ...
                      _a = this;
                      return [4, (this._options.getRTCIceCandidateStatsReport || stats.getRTCIceCandidateStatsReport)(call2["_mediaHandler"].version.pc)];
                    case 1:
            ...
            [{
              ...
              var originalHandler = call2["_mediaHandler"][handlerName];
              call2["_mediaHandler"][handlerName] = function(state) {
        ...
        })(exports$1.PreflightTest || (exports$1.PreflightTest = {}));
      }, { "../call.js": 9, "../constants.js": 10, "../device.js": 12, "../errors/generated.js": 14, "../errors/index.js": 15, "../log.js": 18, "../rtc/stats.js": 32, "events": 39, "tslib": 41 }], 21: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var tslib = require2("tslib");
        var events = require2("events");
        var constants = require2("./constants.js");
        require2("./errors/index.js");
        var log = require2("./log.js");
        var wstransport = require2("./wstransport.js");
        var generated = require2("./errors/generated.js");
        ...
        var PStream = (
          /** @class */
          (function(_super) {
            tslib.__extends(PStream2, _super);
            function PStream2(token, uris, options) {
              ...
              _this.addListener("offline", function() {
                self2.status = "offline";
              });
              _this.addListener("close", function() {
                self2._log.info('Received "close" from server. Destroying PStream...');
                self2._destroy();
              });
        ...
        exports$1.default = PStream;
      }, { "./constants.js": 10, "./errors/generated.js": 14, "./errors/index.js": 15, "./log.js": 18, "./wstransport.js": 38, "events": 39, "tslib": 41 }], 22: [function(require2, module, exports$1) {
        var index = require2("./errors/index.js");
        var _a;
        exports$1.Edge = void 0;
        (function(Edge) {
          Edge["Sydney"] = "sydney";
        ...
        })(exports$1.Edge || (exports$1.Edge = {}));
        exports$1.Region = void 0;
        (function(Region) {
          Region["Au1"] = "au1";
          Region["Au1Ix"] = "au1-ix";
          Region["Br1"] = "br1";
        ...
        })(exports$1.Region || (exports$1.Region = {}));
        var regionShortcodes = {
          ASIAPAC_SINGAPORE: exports$1.Region.Sg1,
          ASIAPAC_SYDNEY: exports$1.Region.Au1,
          ASIAPAC_TOKYO: exports$1.Region.Jp1,
          EU_FRANKFURT: exports$1.Region.De1,
          EU_IRELAND: exports$1.Region.Ie1,
          SOUTH_AMERICA_SAO_PAULO: exports$1.Region.Br1,
          US_EAST_VIRGINIA: exports$1.Region.Us1,
          US_WEST_OREGON: exports$1.Region.Us2
        };
        var regionToEdge = (_a = {}, _a[exports$1.Region.Au1] = exports$1.Edge.Sydney, _a[exports$1.Region.Br1] = exports$1.Edge.SaoPaulo, _a[exports$1.Region.Ie1] = exports$1.Edge.Dublin, _a[exports$1.Region.De1] = exports$1.Edge.Frankfurt, _a[exports$1.Region.Jp1] = exports$1.Edge.Tokyo, _a[exports$1.Region.Sg1] = exports$1.Edge.Singapore, _a[exports$1.Region.Us1] = exports$1.Edge.Ashburn, _a[exports$1.Region.Us2] = exports$1.Edge.Umatilla, _a[exports$1.Region.Gll] = exports$1.Edge.Roaming, /**
        * Interconnect edges
        */
        _a[exports$1.Region.Us1Ix] = exports$1.Edge.AshburnIx, _a[exports$1.Region.Us2Ix] = exports$1.Edge.SanJoseIx, _a[exports$1.Region.Ie1Ix] = exports$1.Edge.LondonIx, _a[exports$1.Region.De1Ix] = exports$1.Edge.FrankfurtIx, _a[exports$1.Region.Sg1Ix] = exports$1.Edge.SingaporeIx, _a[exports$1.Region.Au1Ix] = exports$1.Edge.SydneyIx, _a[exports$1.Region.Jp1Ix] = exports$1.Edge.TokyoIx, /**
        * Tnx regions
        */
        _a[exports$1.Region.Us1Tnx] = exports$1.Edge.AshburnIx, _a[exports$1.Region.Us2Tnx] = exports$1.Edge.AshburnIx, _a[exports$1.Region.Ie1Tnx] = exports$1.Edge.LondonIx, _a[exports$1.Region.Sg1Tnx] = exports$1.Edge.SingaporeIx, _a);
        var defaultEdge = exports$1.Edge.Roaming;
        ...
        exports$1.createEventGatewayURI = createEventGatewayURI;
        exports$1.createSignalingEndpointURL = createSignalingEndpointURL;
        exports$1.defaultEdge = defaultEdge;
        exports$1.getChunderURIs = getChunderURIs;
        exports$1.getRegionShortcode = getRegionShortcode;
        exports$1.regionShortcodes = regionShortcodes;
        exports$1.regionToEdge = regionToEdge;
      }, { "./errors/index.js": 15 }], 23: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
      ...
      }, {}], 24: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var index = require2("../errors/index.js");
        var util = require2("../util.js");
        function getUserMedia(constraints, options) {
          ...
          return new Promise(function(resolve, reject) {
            ...
            throw options.util.isFirefox() && e.name === "NotReadableError" ? new index.NotSupportedError("Firefox does not currently support opening multiple audio input trackssimultaneously, even across different tabs.\nRelated Bugzilla thread: https://bugzilla.mozilla.org/show_bug.cgi?id=1299324") : e;
          });
        }
        exports$1.default = getUserMedia;
      }, { "../errors/index.js": 15, "../util.js": 37 }], 25: [function(require2, module, exports$1) {
        var IceCandidate = (
          /** @class */
          (function() {
        ...
        exports$1.IceCandidate = IceCandidate;
      }, {}], 26: [function(require2, module, exports$1) {
        var peerconnection = require2("./peerconnection.js");
        var rtcpc = require2("./rtcpc.js");
        function enabled() {
        ...
        exports$1.PeerConnection = peerconnection.default;
        exports$1.enabled = enabled;
        exports$1.getMediaEngine = getMediaEngine;
      }, { "./peerconnection.js": 29, "./rtcpc.js": 30 }], 27: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        ...
        exports$1.default = MockRTCStatsReport;
      }, {}], 28: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var r0 = 94.768;
        ...
        exports$1.calculate = calculate;
        exports$1.default = Mos;
        exports$1.isNonNegativeNumber = isNonNegativeNumber;
      }, {}], 29: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var index = require2("../errors/index.js");
        var log = require2("../log.js");
        var util = require2("../util.js");
        var rtcpc = require2("./rtcpc.js");
        var sdp = require2("./sdp.js");
        var generated = require2("../errors/generated.js");
        ...
        PeerConnection.prototype.setInputTracksFromStream = function(stream) {
          ...
          return this._setInputTracksFromStream(true, stream).then(function() {
            self2._shouldManageStream = false;
          });
        };
        ...
        PeerConnection.prototype._startPollingVolume = function() {
          ...
          setTimeout(function emitVolume() {
            if (!self2._audioContext) {
              return;
            } else if (self2.status === "closed") {
              self2._inputAnalyser.disconnect();
              self2._outputAnalyser.disconnect();
              self2._inputAnalyser2.disconnect();
              self2._outputAnalyser2.disconnect();
              return;
            }
            self2._inputAnalyser.getByteFrequencyData(inputDataArray);
            var inputVolume = self2.util.average(inputDataArray);
            self2._inputAnalyser2.getByteFrequencyData(inputDataArray);
            var inputVolume2 = self2.util.average(inputDataArray);
            self2._outputAnalyser.getByteFrequencyData(outputDataArray);
            var outputVolume = self2.util.average(outputDataArray);
            self2._outputAnalyser2.getByteFrequencyData(outputDataArray);
            var outputVolume2 = self2.util.average(outputDataArray);
            self2.onvolume(inputVolume / 255, outputVolume / 255, inputVolume2, outputVolume2);
        ...
        PeerConnection.prototype._updateAudioOutputs = function updateAudioOutputs() {
          ...
          return Promise.all(createOutputPromises).then(function() {
            return Promise.all(removedOutputIds.map(self2._removeAudioOutput, self2));
          });
        };
        ...
        PeerConnection.prototype._createAudioOutput = function createAudioOutput(id) {
          ...
          setAudioSource(audio, dest && dest.stream ? dest.stream : this.pcStream, this._audioHelper).catch(function() {
            return _this._log.error("Error attaching stream to element (_createAudioOutput).");
          });
          var self2 = this;
          return audio.setSinkId(id).then(function() {
            return audio.play();
          }).then(function() {
            self2.outputs.set(id, {
              audio,
              dest
            });
          });
        ...
        PeerConnection.prototype._onAddTrack = function onAddTrack(pc, stream) {
          ...
          setAudioSource(audio, stream, this._audioHelper).then(function() {
            return audio.play();
          }).catch(function() {
            return pc._log.error("Error attaching stream to element (_onAddTrack).");
          });
          var activeDeviceId = Array.from(pc.outputs.keys())[0];
        ...
        PeerConnection.prototype._fallbackOnAddTrack = function fallbackOnAddTrack(pc, stream) {
          ...
          setAudioSource(audio, stream, this._audioHelper).then(function() {
            ...
            return pc._log.error("Error attaching stream to element (_fallbackOnAddTrack).");
          });
        ...
        PeerConnection.prototype._setupPeerConnection = function(rtcConfiguration) {
          ...
          version.pc[eventName] = function(event) {
            var stream = self2._remoteStream = event.stream || event.streams[0];
            if (typeof version.pc.getSenders === "function") {
              _this._sender = version.pc.getSenders()[0];
            }
            if (self2._isSinkSupported) {
              self2._onAddTrack(self2, stream);
            } else {
              self2._fallbackOnAddTrack(self2, stream);
            }
            self2._startPollingVolume();
          };
          return version;
        };
        ...
        PeerConnection.prototype.iceRestart = function() {
          ...
          this.version.createOffer(this.options.maxAverageBitrate, { iceRestart: true }).then(function() {
            ...
            _this._onAnswerOrRinging = function(payload) {
              ...
              var sdp2 = _this._maybeSetIceAggressiveNomination(payload.sdp);
              _this._answerSdp = sdp2;
              if (_this.status !== "closed") {
                _this.version.processAnswer(_this.codecPreferences, sdp2, null, function(err) {
        ...
        PeerConnection.prototype.makeOutgoingCall = function(params, signalingReconnectToken, callsid, rtcConfiguration, onMediaStarted) {
          ...
          function onAnswerSuccess() {
            if (self2.options) {
              self2._setEncodingParameters(self2.options.dscp);
            }
            onMediaStarted(self2.version.pc);
          }
          ...
          this._onAnswerOrRinging = function(payload) {
            ...
            var sdp2 = _this._maybeSetIceAggressiveNomination(payload.sdp);
            self2._answerSdp = sdp2;
            if (self2.status !== "closed") {
              self2.version.processAnswer(_this.codecPreferences, sdp2, onAnswerSuccess, onAnswerError);
            }
            self2.pstream.removeListener("answer", self2._onAnswerOrRinging);
            self2.pstream.removeListener("ringing", self2._onAnswerOrRinging);
          };
          ...
          function onOfferSuccess() {
            if (self2.status !== "closed") {
              if (signalingReconnectToken) {
                self2.pstream.reconnect(self2.version.getSDP(), self2.callSid, signalingReconnectToken);
              } else {
                self2.pstream.invite(self2.version.getSDP(), self2.callSid, params);
              }
              self2._setupRTCDtlsTransportListener();
            }
          }
        ...
        PeerConnection.prototype.answerIncomingCall = function(callSid, sdp2, rtcConfiguration, onMediaStarted) {
          if (!this._initializeMediaStream(rtcConfiguration)) {
            return;
          }
          sdp2 = this._maybeSetIceAggressiveNomination(sdp2);
          this._answerSdp = sdp2.replace(/^a=setup:actpass$/gm, "a=setup:passive");
          this.callSid = callSid;
          var self2 = this;
          function onAnswerSuccess() {
            if (self2.status !== "closed") {
              self2.pstream.answer(self2.version.getSDP(), callSid);
              if (self2.options) {
                self2._setEncodingParameters(self2.options.dscp);
              }
              onMediaStarted(self2.version.pc);
          ...
          this.version.processSDP(this.options.maxAverageBitrate, this.codecPreferences, sdp2, { audio: true }, onAnswerSuccess, onAnswerError);
        };
        ...
        PeerConnection.prototype.getOrCreateDTMFSender = function getOrCreateDTMFSender() {
          ...
          if (typeof pc.createDTMFSender === "function" && typeof pc.getLocalStreams === "function") {
            var track = pc.getLocalStreams().map(function(stream) {
              var tracks = self2._getAudioTracks(stream);
        ...
        PeerConnection.protocol = (function() {
          return rtcpc.default.test() ? new rtcpc.default() : null;
        })();
        PeerConnection.prototype._handleAudioProcessorEvent = function(isRemote, isAddProcessor) {
          ...
          setAudioSource(audio, this._remoteStream, this._audioHelper).then(function() {
            var successLog = isAddProcessor ? "Successfully updated audio source with processed stream" : "Successfully reverted audio source to original stream";
            ...
            var errorLog = isAddProcessor ? "Failed to update audio source" : "Failed to revert audio source";
        ...
        exports$1.default = PeerConnection;
      }, { "../errors/generated.js": 14, "../errors/index.js": 15, "../log.js": 18, "../util.js": 37, "./rtcpc.js": 30, "./sdp.js": 31 }], 30: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var log = require2("../log.js");
        var util = require2("../util.js");
        var sdp = require2("./sdp.js");
        ...
        exports$1.default = RTCPC;
      }, { "../log.js": 18, "../util.js": 37, "./sdp.js": 31 }], 31: [function(require2, module, exports$1) {
        var util = require2("../util.js");
        ...
        exports$1.getPreferredCodecInfo = getPreferredCodecInfo;
        exports$1.setCodecPreferences = setCodecPreferences;
        exports$1.setIceAggressiveNomination = setIceAggressiveNomination;
        exports$1.setMaxAverageBitrate = setMaxAverageBitrate;
      }, { "../util.js": 37 }], 32: [function(require2, module, exports$1) {
        var tslib = require2("tslib");
        var index = require2("../errors/index.js");
        var mockrtcstatsreport = require2("./mockrtcstatsreport.js");
        ...
        function getRTCStatsReport(peerConnection) {
          ...
          try {
            ...
            }).then(mockrtcstatsreport.default.fromRTCStatsResponse);
          }
          return promise;
        }
        ...
        exports$1.getRTCIceCandidateStatsReport = getRTCIceCandidateStatsReport;
        exports$1.getRTCStats = getRTCStats;
      }, { "../errors/index.js": 15, "./mockrtcstatsreport.js": 27, "tslib": 41 }], 33: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        ...
        exports$1.default = MediaDeviceInfoShim;
      }, {}], 34: [function(require2, module, exports$1) {
        var index = require2("./errors/index.js");
        function generateRandomizedString() {
          ...
          if (typeof crypto.getRandomValues !== "function") {
            throw new index.NotSupportedError("The function `crypto.getRandomValues` is not available on this platform.");
          }
        ...
        exports$1.generateVoiceEventSid = generateVoiceEventSid;
      }, { "./errors/index.js": 15 }], 35: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var asyncQueue = require2("./asyncQueue.js");
        var audioplayer = require2("./audioplayer/audioplayer.js");
        var index = require2("./errors/index.js");
        function Sound(name, url, options) {
          ...
          options.AudioPlayer = options.audioContext ? audioplayer.default.bind(audioplayer.default, options.audioContext) : options.AudioFactory;
          Object.defineProperties(this, {
        ...
        Sound.prototype._play = function _play(forceIsMuted, forceShouldLoop) {
          ...
          var playPromise = this._playPromise = Promise.all(this._sinkIds.map(function createAudioElement(sinkId) {
            ...
            var audioElement = self2._activeEls.get(sinkId);
            if (audioElement) {
              return self2._playAudioElement(sinkId, forceIsMuted, forceShouldLoop);
            }
            audioElement = new self2._Audio(self2.url);
            ...
            return new Promise(function(resolve) {
              ...
              return (self2._isSinkSupported ? audioElement.setSinkId(sinkId) : Promise.resolve()).then(function setSinkIdSuccess() {
                self2._activeEls.set(sinkId, audioElement);
                if (!self2._playPromise) {
                  return Promise.resolve();
                }
                return self2._playAudioElement(sinkId, forceIsMuted, forceShouldLoop);
              });
        ...
        exports$1.default = Sound;
      }, { "./asyncQueue.js": 2, "./audioplayer/audioplayer.js": 4, "./errors/index.js": 15 }], 36: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var tslib = require2("tslib");
        var events = require2("events");
        var index = require2("./errors/index.js");
        var mos = require2("./rtc/mos.js");
        var stats = require2("./rtc/stats.js");
        var util = require2("./util.js");
        ...
        function flattenSamples(sampleSets) {
          return sampleSets.reduce(function(flat, current) {
            return tslib.__spreadArray(tslib.__spreadArray([], flat, true), current, true);
          }, []);
        }
        var StatsMonitor = (
          /** @class */
          (function(_super) {
            tslib.__extends(StatsMonitor2, _super);
            ...
            StatsMonitor2.prototype._createSample = function(stats2, previousSample) {
              ...
              var currentBytesSent = stats2.bytesSent - previousBytesSent;
              var currentBytesReceived = stats2.bytesReceived - previousBytesReceived;
              var currentPacketsSent = stats2.packetsSent - previousPacketsSent;
              var currentPacketsReceived = stats2.packetsReceived - previousPacketsReceived;
              var currentPacketsLost = stats2.packetsLost - previousPacketsLost;
              ...
              var totalInboundPackets = stats2.packetsReceived + stats2.packetsLost;
              var totalPacketsLostFraction = totalInboundPackets > 0 ? stats2.packetsLost / totalInboundPackets * 100 : 100;
              var rttValue = typeof stats2.rtt === "number" || !previousSample ? stats2.rtt : previousSample.rtt;
              ...
              return {
                ...
                codecName: stats2.codecName,
                jitter: stats2.jitter,
                mos: this._mos.calculate(rttValue, stats2.jitter, previousSample && currentPacketsLostFraction),
                packetsLost: currentPacketsLost,
                packetsLostFraction: currentPacketsLostFraction,
                packetsReceived: currentPacketsReceived,
                packetsSent: currentPacketsSent,
                rtt: rttValue,
                timestamp: stats2.timestamp,
                totals: {
                  bytesReceived: stats2.bytesReceived,
                  bytesSent: stats2.bytesSent,
                  packetsLost: stats2.packetsLost,
                  packetsLostFraction: totalPacketsLostFraction,
                  packetsReceived: stats2.packetsReceived,
                  packetsSent: stats2.packetsSent
                }
              };
            };
        ...
        exports$1.default = StatsMonitor;
      }, { "./errors/index.js": 15, "./rtc/mos.js": 28, "./rtc/stats.js": 32, "./util.js": 37, "events": 39, "tslib": 41 }], 37: [function(require2, module, exports$1) {
        (function(global2) {
          (function() {
            ...
            function isFirefox(navigator2) {
              navigator2 = navigator2 || (typeof window === "undefined" ? global2.navigator : window.navigator);
            ...
            exports$1.average = average;
            exports$1.difference = difference;
            exports$1.flatMap = flatMap;
            exports$1.isChrome = isChrome;
            exports$1.isElectron = isElectron;
            exports$1.isFirefox = isFirefox;
            exports$1.isLegacyEdge = isLegacyEdge;
            exports$1.isSafari = isSafari;
            exports$1.promisifyEvents = promisifyEvents;
            exports$1.queryToJson = queryToJson;
            exports$1.sortByMimeTypes = sortByMimeTypes;
          }).call(this);
        }).call(this, typeof commonjsGlobal !== "undefined" ? commonjsGlobal : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
      }, {}], 38: [function(require2, module, exports$1) {
        Object.defineProperty(exports$1, "__esModule", { value: true });
        var tslib = require2("tslib");
        var events = require2("events");
        var backoff = require2("./backoff.js");
        ...
        exports$1.WSTransportState = void 0;
        (function(WSTransportState) {
          WSTransportState["Connecting"] = "connecting";
          WSTransportState["Closed"] = "closed";
          WSTransportState["Open"] = "open";
        })(exports$1.WSTransportState || (exports$1.WSTransportState = {}));
        var WSTransport = (
          /** @class */
          (function(_super) {
            tslib.__extends(WSTransport2, _super);
            function WSTransport2(uris, options) {
              if (options === void 0) {
                options = {};
              }
              var _this = _super.call(this) || this;
              _this.state = exports$1.WSTransportState.Closed;
              ...
              _this._onSocketClose = function(event) {
                ...
                if (event.code === 1006 || event.code === 1015) {
                  ...
                  var wasConnected = (
                    ...
                    _this.state === exports$1.WSTransportState.Open || // But on other browsers, websocket doesn't drop
                    ...
                    _this._previousState === exports$1.WSTransportState.Open
                  );
              ...
              _this._onSocketMessage = function(message) {
                ...
                if (message && typeof message.data === "string") {
                  ...
                  if (type === "error" && payload.error && payload.error.retryAfter) {
                    _this._retryAfter = payload.error.retryAfter * 1e3;
                  }
                }
              ...
              _this._onSocketOpen = function() {
                ...
                _this._shouldFallback = false;
                _this._setState(exports$1.WSTransportState.Open);
              ...
              _this._options = tslib.__assign(tslib.__assign({}, WSTransport2.defaultConstructorOptions), options);
              _this._uris = uris;
              _this._backoff = null;
              return _this;
            }
            ...
            WSTransport2.prototype._close = function() {
              this._setState(exports$1.WSTransportState.Closed);
              this._closeSocket();
            };
            WSTransport2.prototype._closeSocket = function() {
              ...
              if (this.state !== exports$1.WSTransportState.Closed) {
                if (!this._backoff) {
            ...
            WSTransport2.prototype._connect = function(uri, retryCount) {
              ...
              this._closeSocket();
              this._setState(exports$1.WSTransportState.Connecting);
            ...
            WSTransport2.prototype._setupBackoffs = function() {
              ...
              var maxPreferredDurationMs = preferredRetryAfter ? this._options.maxRetryAfterDurationMs : this._options.maxPreferredDurationMs;
              ...
              preferredBackoff.on("backoff", function(attempt, delay) {
                if (_this.state === exports$1.WSTransportState.Closed) {
        ...
        exports$1.default = WSTransport;
      }, { "./backoff.js": 8, "./errors/generated.js": 14, "./errors/index.js": 15, "./log.js": 18, "events": 39, "tslib": 41 }], 39: [function(require2, module, exports$1) {
      ...
      }, {}], 40: [function(require2, module, exports$1) {
      ...
      }, {}], 41: [function(require2, module, exports$1) {
        (function(global2) {
          (function() {
            var __extends;
            var __assign;
            ...
            (function(factory) {
              var root2 = typeof global2 === "object" ? global2 : typeof self === "object" ? self : typeof this === "object" ? this : {};
              if (typeof module === "object" && typeof module.exports === "object") {
                factory(createExporter(root2, createExporter(module.exports)));
              } else {
                factory(createExporter(root2));
              }
              function createExporter(exports$12, previous) {
                if (exports$12 !== root2) {
                ...
                return function(id, v) {
                  return exports$12[id] = previous ? previous(id, v) : v;
                };
              }
            })(function(exporter) {
...
var twilioExports = requireTwilio();
const twilio = /* @__PURE__ */ _mergeNamespaces$1({
  __proto__: null
}, [twilioExports]);
export {
  twilio as t
